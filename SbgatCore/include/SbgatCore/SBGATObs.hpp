...
\author Jay McMahon
\date October 2018
\brief Defines the SBGATObs class
\details Defines the SBGATObs that is the base class for synthetic observation generations.
This class is responsible for shape model pre-processing used.
