...
/**
@file SBGATObsLightcurve.hpp
@class  SBGATObsLightcurve
@author Benjamin Bercovici
@author Jay McMahon
@date October 2018
@brief Defines the SBGATObsLightcurve class
@details Defines the SBGATObsLightcurve class, used to generate lightcurves over a 
 single/binary asteroid system at a fixed phase angle 
