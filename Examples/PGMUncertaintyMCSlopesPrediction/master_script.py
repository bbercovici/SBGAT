...
if (socket.gethostname() == "fortuna"):
    base_location = "/orc_raid/bebe0705/PGMUncertaintyMCSlopesPrediction/"
else:
    base_location = "../"


# SIM_PREFIX will be added to the name of every folder to be put in input/ and output/ 
SIM_PREFIX = "PGMUncertaintyMCSlopesPrediction"
...
for data in all_data:
    ...
    os.system("./PGMUncertaintyMCSlopesPrediction 2>&1 | tee -a " + data["OUTPUT_DIR"] + "log.txt" )
